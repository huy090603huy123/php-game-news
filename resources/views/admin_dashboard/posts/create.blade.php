...
{{-- 										
										<div class="mb-3">
											<label for="created_at" class="form-label">Ngày giờ đăng</label>
											<input type="datetime-local" name="created_at" class="form-control" id="created_at" value="{{ old('created_at') }}">
											@error('created_at')
												<p class="text-danger">{{ $message }}</p>
											@enderror
										</div> --}}
