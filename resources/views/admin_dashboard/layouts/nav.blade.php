...
<div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                ...
                <div>
                    <h4 style="color: #8E24AA" class="logo-text">GAMEVN</h4>
                </div>
                <div style="color: #8E24AA" class="toggle-icon ms-auto"><i class='bx bx-arrow-to-left'></i>
            </div>
        </div>
        <!--navigation-->
        <ul class="metismenu" id="menu">
                ...
                @if(checkPermission("admin.polls.index") || checkPermission("admin.polls.create"))
                <li>
                    <a href="javascript:;" class="has-arrow">
                        <div class="parent-icon"><i class='bx bx-poll'></i></div>
                        <div class="menu-title">Bình chọn</div>
                    </a>
                    <ul>
                        @if(checkPermission("admin.polls.index"))
                        <li> <a href="{{ route('admin.polls.index') }}"><i class="bx bx-right-arrow-alt"></i>Tất cả bình chọn</a></li>
                        @endif
                        @if(checkPermission("admin.polls.create"))
                        <li> <a href="{{ route('admin.polls.create') }}"><i class="bx bx-right-arrow-alt"></i>Thêm bình chọn</a></li>
                        @endif
                    </ul>
                </li>
                @endif
